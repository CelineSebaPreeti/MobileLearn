        ...
        <a href="Reports.jsp" data-role="button" data-inline="true">Reports</a>
          ...
          <div class="pg">
                    <div class="side">
                       ...
                       <a href="EditGPName.jsp" data-role="button" data-corners="false" class="ui-btn-active">Change Group Name</a>
                    ...
                    <div class="mainup" data-role="primary-content">
                        ...
                        <div data-role="main" class="ui-content" align="center">
                          ...
                          <div data-role="main" class="ui-content" align="center">
      <h2>Enter the new Group Name</h2></div>
 
    <form id="edit" name="groupadd" method="post" action="editgroup" data-ajax="false" onsubmit="return validate()">
        ...
        <input type="text" name="group_id" id="gid" placeholder="Group ID" data-clear-btn="true" data-inline="true" onblur="validateID()"><span id=fid_msg style="color:red"></span><br>
         ...
         <br>
      <input type="text" name="group_name" id="gname" placeholder=" New Group Name" data-clear-btn="true" data-inline="true" /></div>
      <br>
      <input type="submit" value="CHANGE NAME" data-inline="true"/>
