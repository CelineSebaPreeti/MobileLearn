            ...
            <script>
                ...
                function validateID()
                {
                    ...
                    function check()
                    {
                        ...
                        {
                            document.getElementById("fid_msg").innerHTML="*SELECT A MODULE TO DELETE";
            ...
            <div data-role="main" class="ui-content">
                ...
                <div class="pg">
                    <div class="side">
                       ...
                       <a href="AddModGrp.jsp" data-role="button" data-corners="false" class="ui-btn-active">Add Module To Group</a>
                    ...
                    <div class="mainup" data-role="primary-content">
                        ...
                        <div data-role="main" class="ui-content" align="center">
                            ...
                            <div data-role="main" class="ui-content" align="center" >
                                ...
                                <h2>Enter the group id and select the module you wish to add them</h2></div>
                            <form id="edit" name="groupadd" method="post" action="addmodtogrp" data-ajax="false" onsubmit="return validate()">
                                <input type="text" name="group_id" id="gid" placeholder="Group ID" data-clear-btn="true" data-inline="true" onblur="validateID()"><span id=fid_msg style="color:red"></span><br>
                                <table class="t" border="5" cellpadding="2" cellspacing="2" align="center">
                                    ...
                                    <%
                                        ...
                                        String sql = "select module_id,title from contentmodule";
                                        ResultSet rs = stmt.executeQuery(sql);

                                        String sql2 = "select count(module_id) FROM contentmodule ";
                                        ResultSet rs1 = stmt1.executeQuery(sql2);
                                        rs1.next();
                                        int ct = rs1.getInt(1);
                                        String count = Integer.toString(ct);
                                        session.setAttribute("num8", count);
                                        stmt1.close();
                                        i = 0;
                                        rb = new Contents[ct];
                                        while (rs.next()) {
                                            ...
                                            rb[i].setTitle(rs.getString(2));
                                    %>
                                    <tr>
                                        <td><%=rs.getString(1)%></td>
                                        <td><%=rs.getString(2)%></td>
                                        <td><input id="ch1" type="checkbox" name="ap8" value="<%=rs.getString(1)%>" onsubmit="return check()"/></td>
                                        </tr>
                                    <%
                                            i++;

                                        }
                                        session.setAttribute("rb8", rb);
                                        stmt.close();
                                        con.close();
                                    %>

                                </table><br/><br/>
                                <input type="submit" value="Add" data-inline="true" class="s"/>
                            </form>
