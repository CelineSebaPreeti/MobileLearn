    ...
    <body>
        <script>
            ...
            function validateName()
            {
                var form=document.getElementById("edit");
                var exp=/^[A-Za-z\s]+$/;
                if(form.group_name.value.match(exp))
                {
                ...
                if(! form.group_name.value.match(exp))
                {
                    document.getElementById("fname_msg").innerHTML="*Invalid Group Name";
                    return false;
                }
            }
        </script>
        ...
        <div class="pg">
            <div class="side">
                ...
                <div data-role="controlgroup" class="ad">
                    ...
                    <a href="AddUserGP.jsp" data-role="button" data-corners="false" class="ui-btn-active">AddGroup</a>
            ...
            <div class="mainup" data-role="primary-content">
                ...
                <div data-role="main" class="ui-content" align="center">
                    ...
                    <div data-role="main" class="ui-content" align="center" >
                        <h2>Enter Group Names To Add</h2></div><center>
                        <form id="edit" name="groupadd" method="post" action="addgroup" data-ajax="false" onsubmit="return validate()">
                            ...
                            <div data-role="fieldcontainer" id="un"><br><br><br>
                                ...
                                <br>
                                <input type="text" name="group_name" id="gname" placeholder="Group Name" data-clear-btn="true" data-inline="true" onblur="validateName()"><span id=fname_msg style="color:red" ></span><br></div>
                            <br>
                            <input type="submit" value="ADD GROUP" data-inline="true"/>
                        </form></center>
                </div></div></div>
    </body>
</html>
