  ...
  <div data-role="main" class="ui-content">
      ...
      <div class="pg">
                    <div class="side">
                       ...
                       <a href="DelUser.jsp" data-role="button" data-corners="false" class="ui-btn-active">Delete User</a>
       ...
       <h2>Select the users you wish to delete</h2></div>
          <form id="edit" name="groupadd" method="post" action="deluser" data-ajax="false" onsubmit="return check()">
            ...
            Statement stmt=con.createStatement();
             Statement stmt1=con.createStatement();
                String sql="select uid,group_id from User_grp_mapping";
                 ...
                 String sql2="select count(*) FROM User_grp_mapping";
             ...
             stmt1.close();
                ...
                {   
                   ...
                   rb[i].setGid(rs.getString(2));
                           %>
                    <tr>
                      <td><%=rs.getString(1)%></td>
                        <td><%=rs.getString(2)%></td>
                         <td><input type="checkbox" id="ch1" name="ap" value="yes"/></td>
                    </tr>
                    <%
                    i++;
                    
                  }
                session.setAttribute("rb2",rb);
                stmt.close();
        con.close();
                  %>
