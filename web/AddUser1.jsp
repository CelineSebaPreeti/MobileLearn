                ...
                <div class="pg">
                    <div class="side">
                        ...
                        <div data-role="controlgroup" class="ad">
                             ...
                             <a href="AddUser1.jsp" data-role="button" data-corners="false" class="ui-btn-active">Add User</a>
                    ...
                    <div class="mainup" data-role="primary-content">
                        ...
                        <div data-role="main" class="ui-content" align="center">
                            ...
                            <div data-role="main" class="ui-content" align="center" >
                                ...
                                <h2>Select the users and enter the group id you wish to add them</h2></div>
                            <form id="edit" name="groupadd" method="post" action="adduser" data-ajax="false" onsubmit="return validate()">
                                ...
                                <table class="t" border="5" cellpadding="2" cellspacing="2" align="center">
                                    ...
                                    <%
                                        ...
                                        String sql = "select uid,designation from User";
                                        ResultSet rs = stmt.executeQuery(sql);

                                        String sql2 = "select count(uid) FROM User ";
                                        ...
                                        while (rs.next()) {
                                            ...
                                            rb[i].setDesign(rs.getString(2));
                                    %>
                                    <tr>
                                        <td><%=rs.getString(1)%></td>
                                        <td><%=rs.getString(2)%></td>
                                        <td><input id="ch1" type="checkbox" name="ap9" value="yes" onsubmit="return check()"/></td>
                                    </tr>
                                    <%
                                            i++;

                                        }
                                        session.setAttribute("rb1", rb);
                                        stmt.close();
                                        con.close();
                                    %>

                                </table><br/><br/>
                                <input type="submit" value="Add Users" data-inline="true" class="s"/>
                            </form>
