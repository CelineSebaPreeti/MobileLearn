            ...
            function validateID()
{
	...
	if(! form.group_id.value.match(exp))
	{
        ...
        <div class="pg">
            <div class="side">
                ...
                <div data-role="controlgroup" class="ad">
                    ...
                    <a href="DeleteUserGP.jsp" data-role="button" data-corners="false" class="ui-btn-active">DeleteGroup</a>
            ...
            <div class="mainup" data-role="primary-content">
                ...
                <div data-role="main" class="ui-content" align="center">
                    ...
                    <div data-role="main" class="ui-content" align="center" >
                        <h2>Enter Group Ids To Delete</h2></div><center>
                        <form id="edit" name="groupdelete" method="post" action="deletegroup" data-ajax="false" onsubmit="return validate()">
        ...
        <input type="text" name="group_id" id="gid" placeholder="Group ID" data-clear-btn="true" data-inline="true" onblur="validateID()"><span id=fid_msg style="color:red" ></span><br>
               ...
               <br>
      <input type="submit" value="DELETE GROUP" data-inline="true"/>
    </form>
</center>
                </div></div></div>
    </body>
