    ...
    <body>
        <script>
            ...
            function validateName()
            {
                var form=document.getElementById("edit");
                var exp=/^[A-Za-z\s]+$/;
                if(form.module_name.value.match(exp))
                {
        ...
        <div class="pg">
            <div class="side">
                ...
                <div data-role="controlgroup" class="ad">
                    ...
                    <a href="AddModule.jsp" data-role="button" data-corners="false" class="ui-btn-active">Add Module</a>
                    <a href="DeleteModule.jsp" data-role="button" data-corners="false">Delete Module</a>
            ...
            <div class="mainup" data-role="primary-content">
               <div data-role="main" class="ui-content" align="center">
                ...
                <div data-role="main" class="ui-content" align="center" >
                        <h2>Enter Module Names To Add</h2></div><center>
                        <form id="edit" name="groupadd" method="post" action="addmodule" data-ajax="false" onsubmit="return validate()">
                            ...
                            <div data-role="fieldcontainer" id="un"><br><br><br>
                                ...
                                <br>
                                <input type="text" name="module_name" id="gname" placeholder="Module Name" data-clear-btn="true" data-inline="true" onblur="validateName()"><span id=fname_msg style="color:red" ></span><br></div>
                            <br>
                            <input type="submit" value="ADD MODULE" data-inline="true"/>
                        </form></center>
                </div></div></div>
    </body>
</html>
