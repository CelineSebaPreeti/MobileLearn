...
{
document.getElementById("fid_msg").innerHTML="*SELECT A CONTENT TO DELETE";
  ...
  <div data-role="main" class="ui-content">
      ...
      <div class="pg">
                    <div class="side">
                       ...
                       <a href="DelContent.jsp" data-role="button" data-corners="false" class="ui-btn-active">Delete Content</a>
                    ...
                    <div class="mainup" data-role="primary-content">
                        ...
                        <div data-role="main" class="ui-content" align="center">
                            ...
                            <div data-role="main" class="ui-content" align="center" >
       <h2>Select the contents you wish to delete</h2></div>
          <form id="edit" name="groupadd" method="post" action="delcontent" data-ajax="false" onsubmit="return check()">
        ...
        Contents[] rb;
            Statement stmt=con.createStatement();
             Statement stmt1=con.createStatement();
                String sql="select content_id,module_id from Content_mod_mapping";
                    ResultSet rs=stmt.executeQuery(sql);
               
                 String sql2="select count(*) FROM Content_mod_mapping";
                 ResultSet rs1=stmt1.executeQuery(sql2);
                  rs1.next();
                    int ct=rs1.getInt(1);
                    String count=Integer.toString(ct);
                        session.setAttribute("num7",count);
             stmt1.close();
                                       i = 0;
                   rb = new Contents[ct];
                while(rs.next())
                {   
                    rb[i]=new Contents();
                   rb[i].setContid(rs.getString(1)); 
                   rb[i].setModid(rs.getString(2));
                           %>
                    <tr>
                      <td><%=rs.getString(1)%></td>
                        <td><%=rs.getString(2)%></td>
                        <td><input id="ch1" type="checkbox" name="ap7" value="<%=rs.getString(1) %>" onsubmit="return check()"/></td>
                    </tr>
                    <%
                    i++;
                    
                  }
                session.setAttribute("rb7",rb);
                stmt.close();
        con.close();
                  %>
                  <span id=fid_msg style="color:red"></span>
          </table><br/><br/>
          <input type="submit" value="Delete Contents" data-inline="true" class="s"/>
                 </form>
