...
/**
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
       ...
       String[] approved = request.getParameterValues("ap2");
       HttpSession session=request.getSession();
      int count=Integer.parseInt((String)session.getAttribute("numb"));
     
       User[] rb=(User[])session.getAttribute("rb3");
       String uid;
  ...
  ResultSet rs;
       ...
       con=DriverManager.getConnection(DB_URL,USER,PASSWORD);
        ...
        a=st.executeUpdate("delete from User where uid='"+uid+"'");
